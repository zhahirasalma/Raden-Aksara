...
//    Long poin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tebak4);
        ...
        soal4=findViewById(R.id.iv_la);
        Glide.with(this).load(R.drawable.la).into(soal4);
    ...
    public void showKirim(View view) {
        ...
        if (selectedtext.equals(jawaban[0][3])){
            countDownTimer.cancel();
            Intent intent=new Intent(this, Tebak5Activity.class);
