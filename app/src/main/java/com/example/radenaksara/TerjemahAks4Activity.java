...
public class TerjemahAks4Activity extends AppCompatActivity {
    ...
    String[][] jawaban={{"katon apik","nyawang lawang","katon ajur", "katon alus"}};
    Long poin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terjemah_aks4);
    ...
    public void showKirim(View view) {
        ...
        if (selectedtext.equals(jawaban[0][0])){
            ...
            Intent intent=new Intent(this, TerjemahAks5Activity.class);
